...
<body>
    ...
    <div class="container">
    <div class="display-3 text-center">Add stock</div>
    ...
    <form method="post" class="form-horizontal mt-5">
            ...
            <div class="form-group text-center">
                <div class="row">
                    <label for="item_name" class="col-sm-3 control-label">รับสินค้าจาก</label>
                    <div class="col-sm-9">
                ...
                <div class="row">
                    <label for="item_name" class="col-sm-3 control-label">รหัสบาร์โค้ด</label>
                    <div class="col-sm-9">
                        <input type="text" name="txt_item_name" class="form-control" placeholder="Enter item name...">
                    </div>
                </div>
                ...
                <div class="row">
                    <label for="item_name" class="col-sm-3 control-label">ราคาต่อหน่วย</label>
                    <div class="col-sm-9">
                        <input type="number_formater" name="txt_item_name" class="form-control" placeholder="Enter item name...">
                    </div>
                </div>
