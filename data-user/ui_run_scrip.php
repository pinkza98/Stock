  ...
  <?php include('../components/nav_user.php'); ?>
    ...
    ?>
      <div class="container pt-3">
            <form method='POST' enctype='multipart/form-data' action="../script_auto_begin_log.php">
              <div class="container col-md-5">
                 
                  <label for="formGroupExampleInput" class="form-label"><b>รหัสส่งคำสั่ง :It898989!@#</b></label>
                  <div class="row g-4">
                  <div class="mb-2">
                  <input type="text"  name="txt_key" class="form-control" placeholder="Key" >
                  <div class="col-sm-12"></div>
                  </div>
                  </div>
                
                <div class="mb-3 mt-3 mb-2">    
                  <input type="submit" name="begin_update" class="btn btn-outline-success" value="Update">
