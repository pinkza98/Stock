...
if (isset($_REQUEST['btn_update'])) {
    try {
        ...
        $directory = "img_stock/"; // set uplaod folder path for upadte time previos file remove and new file upload for next use
        ...
        if (!isset($errorMsg)) {
            $update_stmt = $db->prepare("UPDATE test_img SET image = :file_up WHERE id = :id");
...
<div class="container text-center">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <p>
                <img src="img_stock/<?php echo $image; ?>" height="100" width="100" alt="">
            </p>
        </div>
        </div>
    </div>
